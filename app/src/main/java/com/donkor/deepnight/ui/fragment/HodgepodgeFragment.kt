 ...
 */
class HodgepodgeFragment : BaseFragment(), SwipeRefreshLayout.OnRefreshListener {
...
//        mRvCommonList.layoutManager = GridLayoutManager(context, 2)
    ...
    private fun hodgepodgeData(page:Int?) {
        Thread(Runnable {
            val doc: Document = Jsoup.connect(ApiService.BASE_URL  + ApiService.Hodgepodge+page)
