 ...
 */
class LegsFragment : BaseFragment(), SwipeRefreshLayout.OnRefreshListener {
    ...
    private fun legsData(page: Int?) {
        Thread(Runnable {
            val doc: Document = Jsoup.connect(ApiService.BASE_URL + ApiService.Legs + page)
