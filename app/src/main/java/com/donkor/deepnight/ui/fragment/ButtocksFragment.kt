 ...
 */
class ButtocksFragment : BaseFragment(), SwipeRefreshLayout.OnRefreshListener {
...
//        mRvCommonList.layoutManager = GridLayoutManager(context, 2)
    ...
    private fun buttocksData(page:Int?) {
        Thread(Runnable {
            val doc: Document = Jsoup.connect(ApiService.BASE_URL  + ApiService.Buttocks+page)
