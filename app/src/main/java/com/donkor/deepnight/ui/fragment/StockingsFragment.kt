 ...
 */
class StockingsFragment : CommonLazyLoadFragment() {
...
//        Thread(Runnable {
//            val doc: Document = Jsoup.connect(ApiService.BASE_URL + ApiService.ALL_URL + ApiService.Stockings)
//                    .timeout(defaultTimeout).userAgent(defualtUserAgent7).get()
